...
df.loc[
    df["Способ эксплуатации"] == "Электропогружным насосом", "Способ эксплуатации"
] = 3
df.loc[
    df["Способ эксплуатации"] == "Прочие способы эксплуатации", "Способ эксплуатации"
] = 4
...
df_for_regr = (
    df_for_regr.append(df_for_regr_s)
    .append(chg_71)
    .append(df_for_regr_m)
    .append(chg_48_6)
    .append(df_for_regr_e)
)
